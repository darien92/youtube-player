...
internal class SearchWordRepositoryTest: TestCase(){
    ...
    public override fun setUp() {
        ...
        db = Room.inMemoryDatabaseBuilder(
            context, DatabaseService::class.java).build()
    ...
    @Test
    @Throws(Exception::class)
    fun searchWordRepository_whenWordStartMatchingWordISRequested_shouldReturnStartMatchingWordsList(): Unit = runBlocking {
        createWords()
    ...
    @Test
    @Throws(Exception::class)
    fun searchWordRepository_whenNoMatchingWordIsRequested_shouldReturnEmptyList(): Unit = runBlocking {
        createWords()
